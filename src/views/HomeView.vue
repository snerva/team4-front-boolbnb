            ...
            <div class="parallax_layer header">
                <nav class="navbar bg-transparent shadow-none navbar-expand-md px-4">
                    <div class="container">
                        ...
                        <button class="navbar-toggler d-md-none p-2 border border-white" type="button"
            ...
            <div class="container">
                <div class="best-properties py-5 text-center">
                    ...
                    <router-link active-class="active" class="btn bck-orange rounded-pill px-3"
                        :to="{ name: 'properties' }">VIEW ALL PROPERTIES</router-link>
                </div>
                ...
                <div class="yellow-jumbo">
                    <div class="search-bar">
                        <div class="prova">
                            <input class="search-input" type="text" v-model="search" placeholder="Dove vuoi andare?"
                                @keyup="autocomplete" @keyup.enter="getSearch" />
                            <div class="autocomplete-bar" v-if="autocompleteList">
                                <ul>
                                    <li v-for="(hint, index) in autocompleteList" :key="index"
                            ...
                            <a @click="getSearch">
                                <img class="img-search" src="http://127.0.0.1:8000/storage/icons/normal/search.svg"
                                    alt="Search icon" />
                            </a>
                        </div>
                    </div>
